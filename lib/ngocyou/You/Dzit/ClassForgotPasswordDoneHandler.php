...
class You_Dzit_ForgotPasswordDoneHandler extends You_Dzit_BaseActionHandler {
    ...
    protected function populateModelPageContent($page) {
        ...
        $msg = $lang->getMessage('forgotPassword.done', $this->user!==NULL ? Array($this->user->getLoginName()) : NULL);
