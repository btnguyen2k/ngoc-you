<form method="POST" name="{$page.form->getName()}" action="{$page.form->getAction()}">
	...
	<tr>
		<td class="title_form">{$language->getMessage('admin.categorySettings')}</td>
	</tr>
    ...
    <tr>
    	<td>
    		...
    		<tr>
    			<td width="40%">{$language->getMessage('admin.categorySetting.numTopCategories')}</td>
    			<td width="60%">
    				<input name="numTopCategories" value="{$page.form->getField('numTopCategories')}" style="width: 440px;" type="text">
    			</td>
    		</tr>
    		</table>
    	</td>
