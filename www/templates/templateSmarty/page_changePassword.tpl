<form name="{$form->getName()}" action="{$form->getAction()}" method="POST">
    ...
    <tbody>
    	<tr>
    		<td colspan="3" class="title_form">{$language->getMessage('title.changePassword')}</td>
    	</tr>
    	...
    	<tr>
    		<td width="35">&nbsp;</td>
    		<td>{$language->getMessage('member.newPassword')}:</td>
    		<td><input name="newPassword" value="" style="width: 160px;" type="password"></td>
    	</tr>
    	<tr>
    		<td width="35">&nbsp;</td>
    		<td>{$language->getMessage('member.confirmedNewPassword')}:</td>
    		<td><input name="confirmedNewPassword" value="" style="width: 160px;" type="password"></td>
    	</tr>
    	<tr>
