<form name="{$form->getName()}" action="{$form->getAction()}" method="POST">
    ...
    <tbody>
    	<tr>
    		<td colspan="3" class="title_form">{$language->getMessage('title.changeFullName')}</td>
    	</tr>
    	...
    	<tr>
    		...
    		<td><span class="bold">{$currentUser->getFullName()}</span></td>
    	</tr>
    	<tr>
    		<td width="35">&nbsp;</td>
    	...
    	<tr>
    		<td width="35">&nbsp;</td>
    		<td>{$language->getMessage('member.newFullName')}:</td>
    		<td><input name="newFullName" value="{$form->getField('newFullName')}" style="width: 160px;" type="text"></td>
    	</tr>
    	<tr>
