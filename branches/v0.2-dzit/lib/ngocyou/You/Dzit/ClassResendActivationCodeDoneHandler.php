...
class You_Dzit_ResendActivationCodeDoneHandler extends You_Dzit_BaseActionHandler {
    ...
    protected function populateModelPageContent($page) {
        ...
        $msg = $lang->getMessage('resendActivationCode.done', $this->user!==NULL ? Array($this->user->getLoginName()) : NULL);
